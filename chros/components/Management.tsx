...
import { groupNames, evaluateMatch, playerName, standings } from '@chros/scoring';
import type { ControlState, Player } from '@chros/shared';
import { clientId } from '@/lib/client-id';
import { suggestedQualifiers } from '@/lib/tournament';
import MatchEditor, { statusLabels, type Send } from './MatchEditor';
import { StandingsTable, Bracket } from './Board';
import { useConfirmation } from './Confirmation';

export function Players({ state, send }: { state: ControlState; send: Send }) {
